...
class BST_class {
    ...
    void insert(long key, long prev,  String str) {
        root = insert_Recursive(root, key, prev, str);
    }
    ...
    Node insert_Recursive(Node root, long key, long prev, String str) {
        //tree is empty
        if (root == null) {
            root = new Node(key);
            return root;
        }
        root = search_Recursive(root, prev);
        ...
        {
            root.cL++;
            root.left = insert_Recursive(root.left, key, prev, str);
        } else if (key > root.key)    //insert in the right subtree
        {
            root.cR++;
            root.right = insert_Recursive(root.right, key, prev, str);
        }
        // return pointer
        return root;
    }
    ...
    //recursive insert function
    Node search_Recursive(Node root, long key) {
